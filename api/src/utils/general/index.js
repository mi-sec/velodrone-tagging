...
function has( o, ...args ) {
    if ( isString( o ) ) {
        ...
        return args.filter( i => Object.prototype.hasOwnProperty.call( o, i ) ).length === args.length;
    }
    else {
        return false;
    }
...
function findMissingKeys( o, ...args ) {
    ...
    for ( let i = 0; i < args.length; i++ ) {
        if ( !Object.prototype.hasOwnProperty.call( o, args[ i ] ) ) {
            missing.push( args[ i ] );
        }
    }
...
function hasSome( o, ...args ) {
    ...
    if ( isString( o ) ) {
        ...
        return !!( args.filter( i => Object.prototype.hasOwnProperty.call( o, i ) ).length );
    }
    else {
        return false;
    }
...
function objectFilteredForRegex( obj, rx ) {
    ...
    for ( const key in obj ) {
        if ( Object.prototype.hasOwnProperty.call( obj, key ) && rx.test( key ) ) {
            keys[ key ] = obj[ key ];
        }
    }
    return keys;
        ...
        rNP   = o => Promise.resolve( o )
            .then( o => {
                if ( isArray( o ) ) {
                    ...
                    for ( const ka in o ) {
                        if ( Object.prototype.hasOwnProperty.call( o, ka ) ) {
                            oa[ ka ] = rNP( o[ ka ] );
                        }
                    }
